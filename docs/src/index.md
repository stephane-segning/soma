...
Start with the [Overview](00-overview.md) and [Glossary](01-glossary.md), then dive deeper:

- [Soma & Tapia Architecture](architecture/soma-tapia.md) – component responsibilities, diagrams, and deep-link flows.
