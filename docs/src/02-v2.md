...
- `soma-botd`: a hosted peer/bot with read-only bot mode and admin `server-daemon` mode
...
- `DiscoverSpaces`
- service definitions in `proto/spaceroom/v1/membership.proto` that do not appear to be bound as live servers
