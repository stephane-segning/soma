...
The Electron apps focus on user experience and talk to the local daemon over IPC:

- **Soma desktop app**: classes/spaces, documents, blobs, chat, onboarding flows.
- **Tapia**: typing exercises and companion UX; it can read/write relevant data through the same daemon.
