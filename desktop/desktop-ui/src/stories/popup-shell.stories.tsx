			...
			>
				...
				>
					<div className="flex h-full flex-col items-center justify-center gap-6 p-6">
						...
						/>
						<label className="flex w-full max-w-xs flex-col gap-1 text-base-content/60 text-ui-xs">
							<span>Type the phrase above to advance the bar.</span>
							<input
								autoFocus
								className="rounded-md border border-base-300 bg-base-100 px-2 py-1 font-mono text-body outline-none focus-visible:border-primary"
...
function MinimalDemo() {
	...
	return (
		...
		>
			...
			>
				<div className="flex h-full flex-col items-center justify-center text-base-content/60 text-ui-sm">
