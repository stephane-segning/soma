...
function ExercisePlayer({ exercise, onComplete }: ExercisePlayerProps): React.JSX.Element {
  ...
  }, [accuracy, completedAt, exercise.meta.id, exercise.meta.spaceId, input.length, onComplete, startedAt, totalLength, wpm])
    ...
    <div className="player">
      ...
      <div className="player__actions">
        <div className="expected-key">
          ...
          <span className={cn('pill', 'pill--ghost')}>{nextChar ? nextChar : 'done'}</span>
        </div>
