...
container.bind<AppStateSyncService>(TYPES.appStateSyncService).to(AppStateSyncService)
...
container.bind<MainIpcController>(TYPES.mainIpcController).to(MainIpcController)
container.bind<MainBootstrapService>(TYPES.mainBootstrapService).to(MainBootstrapService)
container.bind<MainWindowController>(TYPES.mainWindowController).to(MainWindowController)
...
function resolve(identifier: typeof TYPES.appStateSyncService): AppStateSyncService
function resolve(identifier: typeof TYPES.appSettingsService): AppSettingsService
...
function resolve(identifier: typeof TYPES.mainBootstrapService): MainBootstrapService
function resolve(identifier: typeof TYPES.mainWindowController): MainWindowController
