...
export class MainBootstrapService {
	...
	constructor(
		...
		@inject(TYPES.daemonSyncService)
		private readonly daemonSync: DaemonSyncService,
		@inject(TYPES.daemonSupervisor)
		private readonly daemonSupervisor: DaemonSupervisor,
		@inject(TYPES.mainIpcController)
