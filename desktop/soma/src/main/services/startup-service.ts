...
export class StartupService {
	private readonly deepLinkScheme =
		"soma";
	private mainWindow: BrowserWindow | null =
		null;
	private pendingDeepLink:
		| string
		| null =
		this.extractDeepLink(
			process.argv,
		);
	...
	private openMainWindow(
		...
		this.attachWindowStateTracking(
			this
				.mainWindow,
		);
	}

	private attachWindowStateTracking(
