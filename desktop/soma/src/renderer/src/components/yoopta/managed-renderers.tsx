...
const tableCellClasses =
	cva(
		"yoopta-table-cell align-top",
	);
const accordionClasses =
	cva(
		"yoopta-accordion rounded-box bg-base-200 p-4",
	);
...
const listItemClasses =
	cva(
		"yoopta-list-item flex gap-2",
	);
const listBulletClasses =
	cva(
		"yoopta-list-bullet mt-1 text-base-content",
	);
const todoWrapperClasses =
	cva(
		"yoopta-todo flex items-start gap-2",
	);
const todoCheckboxClasses =
	cva(
		"checkbox checkbox-sm mt-1",
	);
const linkClasses =
	cva(
		"yoopta-link link link-primary",
	);
const embedWrapperClasses =
	cva(
		"yoopta-embed card overflow-hidden border border-base-300 bg-base-200 shadow-sm",
	);
const embedBodyClasses =
	cva(
		"card-body gap-2",
	);
...
const ManagedParagraph =
	memo(
		BaseParagraph,
	);
ManagedParagraph.displayName =
	"ManagedParagraph";
...
const ManagedHeadingOne =
	memo(
		BaseHeadingOne,
	);
ManagedHeadingOne.displayName =
	"ManagedHeadingOne";
...
const ManagedHeadingTwo =
	memo(
		BaseHeadingTwo,
	);
ManagedHeadingTwo.displayName =
	"ManagedHeadingTwo";
...
const ManagedHeadingThree =
	memo(
		BaseHeadingThree,
	);
ManagedHeadingThree.displayName =
	"ManagedHeadingThree";
...
const ManagedBlockquote =
	memo(
		BaseBlockquote,
	);
ManagedBlockquote.displayName =
	"ManagedBlockquote";
...
const ManagedCallout =
	memo(
		BaseCallout,
	);
ManagedCallout.displayName =
	"ManagedCallout";
...
const ManagedTableRow =
	memo(
		BaseTableRow,
	);
ManagedTableRow.displayName =
	"ManagedTableRow";
...
const ManagedTableCell =
	memo(
		BaseTableCell,
	);
ManagedTableCell.displayName =
	"ManagedTableCell";
...
const ManagedNumberedList =
	memo(
		BaseNumberedList,
	);
ManagedNumberedList.displayName =
	"ManagedNumberedList";
...
const ManagedBulletedList =
	memo(
		BaseBulletedList,
	);
ManagedBulletedList.displayName =
	"ManagedBulletedList";
...
const ManagedTodoList =
	memo(
		BaseTodoList,
	);
ManagedTodoList.displayName =
	"ManagedTodoList";
...
ManagedEmbed.displayName =
	"ManagedEmbed";

const renderManagedImage =
	(
...
const renderManagedHeadingThree =
	(
		props: PluginElementRenderProps,
	) => (
		<ManagedHeadingThree
...
const renderManagedNumberedList =
	(
		props: PluginElementRenderProps,
	) => (
		<ManagedNumberedList
...
const renderManagedBulletedList =
	(
		props: PluginElementRenderProps,
	) => (
		<ManagedBulletedList
