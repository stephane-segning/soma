		...
		<div className="space-y-8">
			<div className="space-y-3">
				...
				<p className="max-w-2xl text-base-content/70 text-sm md:text-base">
					Start with a space, then create pages with notes and attachments. If someone already invited you,
					Soma can request access with the connection details they shared.
				</p>
			</div>
			...
			<div className="rounded-2xl border border-dashed border-base-300 bg-base-100/70 p-5">
				<div className="flex items-center justify-between gap-4">
					<div>
						...
						<p className="text-base-content/70 text-sm">Open an existing space or start fresh if this device has not joined one yet.</p>
					</div>
				...
				<div className="mt-4 space-y-2">
					...
					{!spacesQuery.isLoading && spaces.length === 0 ? (
						<div className="rounded-xl border border-dashed border-base-300 px-4 py-3 text-sm text-base-content/60">
