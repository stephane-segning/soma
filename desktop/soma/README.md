...
- `SOMA_DAEMON_SOCKET` (dev-only; prod macOS default: `/tmp/soma-<uid>/soma/soma-daemon.sock`; non-prod default: `/tmp/soma-daemon-<stage>.sock`)
- `SOMA_AGENTD_SOCKET` (dev-only; prod macOS default: `/tmp/soma-<uid>/soma/soma-agentd.sock`; non-prod default: `/tmp/soma-agentd-<stage>.sock`)
